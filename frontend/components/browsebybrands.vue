         ...
         >
            <v-row
                ...
                <v-card-title class=" font-weight-bold" :class="isXS?'h6':'display-1'">
                    <span  style="color:rgb(74, 74, 74)" >Browse By Brands</span>
                </v-card-title>
            </v-row>
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        :src="backend_baseUrl+'/imageResize?url='+brand.logo+'&sizeX=150&sizeY=150' || '/uploads/no_image.png'"
                        height="100"
