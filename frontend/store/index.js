  ...
  export const actions = {
      ...
      checkIsAdminLoggedIn({commit}){
          ...
          this.$axios.$post('/api/auth/meAdmin?token='+localStorage.getItem('token'))
          .then(function (response) {
      ...
      setCurrentUserRoles({commit}){
          ...
          this.$axios.$get('/api/auth/getCurrentUserRoles?token='+localStorage.getItem('token'))
          .then(function (response) {
      ...
      setCurrentUserModules({commit}){
          ...
          this.$axios.$get('/api/auth/getCurrentUserModules?token='+localStorage.getItem('token'))
          .then(function (response) {
      ...
      setCurrentUserWishLists({commit}){
          this.$axios.$get('/api/getCurrentUserWishLists?token='+localStorage.getItem('token'))
          .then(function (response) {
      ...
      setSearchProducts({commit}){
          ...
          if (this.state.searchInput) {
              this.$axios.$post('/api/getSearchProductsWithDiscountCalculation/'+(this.state.searchInput || ''), {token: localStorage.getItem('token')})
              .then(function (response) {
      ...
      setSearchCategoryProducts({commit}){
          this.$axios.$post('/api/getSearchCategoryProductsWithDiscountCalculation/'+this.state.searchCategorySlug, {token: localStorage.getItem('token')})
          .then(function (response) {
      ...
      setDynamicPageInfo({commit}, payload){
          this.$axios.$get('/api/getPageWithSlug/'+payload.pageSlug)
          .then(function (response) {
