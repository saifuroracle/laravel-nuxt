...
/******/ 			var chunk = require("./" + ({"1":"pages/index","2":"pages/login","3":"pages/register"}[chunkId]||chunkId) + ".js");
...
/* harmony import */ var _framework__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
...
/* harmony import */ var _color_transformSRGB__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
// Utilities
...
var transformSRGB = __webpack_require__(4);
...
module.exports.__inject__ = function (context) {
  add("3be9f726", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_error_vue_vue_type_style_index_0_id_36405a0b_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(23);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_error_vue_vue_type_style_index_0_id_36405a0b_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_error_vue_vue_type_style_index_0_id_36405a0b_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_error_vue_vue_type_style_index_0_id_36405a0b_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_error_vue_vue_type_style_index_0_id_36405a0b_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
exports.push([module.i, "h1[data-v-36405a0b]{font-size:20px}", ""]);
// Exports
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(7).default("ba2b540c", content, true)
...
module.exports = __webpack_require__.p + "fonts/MaterialIcons-Regular.e79bfd8.eot";

/***/ }),
/* 43 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "fonts/MaterialIcons-Regular.570eb83.woff2";

/***/ }),
/* 44 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "fonts/MaterialIcons-Regular.012cf6a.woff";

/***/ }),
/* 45 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "fonts/MaterialIcons-Regular.a37b0c0.ttf";
...
const mutations = {
  SET_ISLOGGEDIN(state, value) {
    state.isLoggedIn = value; // console.log('state.isLoggedIn = '+value)
  },
...
const actions = {
  checkIsLoggedIn({
    ...
    this.$axios.$post('/api/auth/me?token=' + localStorage.getItem('token')).then(function (response) {
  ...
  checkIsAdminLoggedIn({
    ...
    this.$axios.$post('/api/auth/meAdmin?token=' + localStorage.getItem('token')).then(function (response) {
  ...
  setCurrentUserRoles({
    ...
    this.$axios.$get('/api/auth/getCurrentUserRoles?token=' + localStorage.getItem('token')).then(function (response) {
  ...
  setCurrentUserModules({
    ...
    this.$axios.$get('/api/auth/getCurrentUserModules?token=' + localStorage.getItem('token')).then(function (response) {
  ...
  setCurrentUserWishLists({
    commit
  }) {
    this.$axios.$get('/api/getCurrentUserWishLists?token=' + localStorage.getItem('token')).then(function (response) {
  ...
  setSearchProducts({
    ...
    if (this.state.searchInput) {
      this.$axios.$post('/api/getSearchProductsWithDiscountCalculation/' + (this.state.searchInput || ''), {
  ...
  setSearchCategoryProducts({
    ...
    this.$axios.$post('/api/getSearchCategoryProductsWithDiscountCalculation/' + this.state.searchCategorySlug, {
      token: localStorage.getItem('token')
    }).then(function (response) {
  ...
  setDynamicPageInfo({
    ...
    this.$axios.$get('/api/getPageWithSlug/' + payload.pageSlug).then(function (response) {
...
const _45b62308 = () => interopDefault(__webpack_require__.e(/* import() | pages/login */ 2).then(__webpack_require__.bind(null, 166)));

const _e9d46e40 = () => interopDefault(__webpack_require__.e(/* import() | pages/register */ 3).then(__webpack_require__.bind(null, 167)));

const _137d4b65 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 1).then(__webpack_require__.bind(null, 168))); // TODO: remove in Nuxt 3
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/error.vue?vue&type=template&id=36405a0b&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',[(_vm.error.statusCode === 404)?_c('h1',[_vm._v("\n    "+_vm._s(_vm.pageNotFound)+"\n  ")]):_c('h1',[_vm._v("\n    "+_vm._s(_vm.otherError)+"\n  ")]),_vm._v(" "),_c('NuxtLink',{attrs:{"to":"/"}},[_vm._v("\n    Home page\n  ")])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./layouts/error.vue?vue&type=template&id=36405a0b&scoped=true&
...
var material_icons = __webpack_require__(39);

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=b5ae32b8&
var defaultvue_type_template_id_b5ae32b8_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('nuxt')],1)}
var defaultvue_type_template_id_b5ae32b8_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=b5ae32b8&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  ...
  defaultvue_type_template_id_b5ae32b8_render,
  defaultvue_type_template_id_b5ae32b8_staticRenderFns,
  false,
  null,
  null,
  "78d8aee3"
...
var framework = __webpack_require__(10);
...
var fontawesome_svg_core_ = __webpack_require__(28);
...
// CONCATENATED MODULE: ./plugins/mixins/common.js
...
external_vue_default.a.mixin({
  ...
  methods: {
    ...
    axiosPost(url) {
      axios.post(url + '?token=' + this.token).then(function (response) {
        alert('success');
      }).catch(function (error) {
        alert('failure!');
      });
    ...
    getNumberOfDaysFrom2YmdDates(YmdDate1 = '', YmdDate2 = '') {
      ...
      if (YmdDate1.length > 0 && YmdDate2.length > 0) {
        ...
        var date2 = new Date(YmdDate2); // To calculate the time difference of two dates
...
// CONCATENATED MODULE: ./plugins/mixins/algorithm.js
...
external_vue_default.a.mixin({
  methods: {
    ...
    arrayOfObjectSortDesc(arryData, sortFieldName) {
      arryData.sort((a, b) => {
        if (a[sortFieldName] > b[sortFieldName]) return -1;
        return a[sortFieldName] < b[sortFieldName] ? 1 : 0;
      });
...
var external_jwt_decode_ = __webpack_require__(18);
...
class runtime_Oauth2Scheme extends runtime_BaseScheme {
  ...
  get redirectURI() {
    return this.options.redirectUri || runtime_urlJoin(external_requrl_(this.req), this.$auth.options.redirect.callback);
  }
...
/* Plugins */
 ...
 // Source: ..\\plugins\\mixins\\common.js (mode: 'all')

 // Source: ..\\plugins\\mixins\\algorithm.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof /* Cannot get final name for export "default" in "./plugins/mixins/common.js" (known exports: , known reexports: ) */ undefined === 'function') {
    await /* Cannot get final name for export "default" in "./plugins/mixins/common.js" (known exports: , known reexports: ) */ undefined(app.context, inject);
  }

  if (typeof /* Cannot get final name for export "default" in "./plugins/mixins/algorithm.js" (known exports: , known reexports: ) */ undefined === 'function') {
    await /* Cannot get final name for export "default" in "./plugins/mixins/algorithm.js" (known exports: , known reexports: ) */ undefined(app.context, inject);
  }
...
"use strict";
/* harmony import */ var _src_components_VApp_VApp_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(33);
